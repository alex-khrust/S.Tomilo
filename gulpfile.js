...
function browsersync() {
	browserSync.init({
		...
		notify: false,
		online: true,
		// tunnel: 'alex-khrust', // Attempt to use the URL https://yousutename.loca.lt
	})
}

function scripts() {
	// return src(['app/js/*.js', '!app/js/*.min.js'])
	return src(['app/js/libs.js', '!app/js/*.min.js'])
		.pipe(webpack({
			mode: 'production',
			module: {
				rules: [
...
function startwatch() {
	...
	watch(['!app/js/**/*.min.js', 'app/js/**/*.js'], { usePolling: true }, scripts)
